...
public class MarineWalkTest {
	...
	public MarineWalkTest() {
		...
		gui.tilePanel.tileMap.getGameBoard().get(19).get(1).addAttacker(new Marine());
		gui.tilePanel.tileMap.getGameBoard().get(19).get(1).getOccupied();
		gui.tilePanel.tileMap.getGameBoard().get(11).get(14).addAttacker(new Marine());
	...
	private class TimeListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			newGUI.tilePanel.tileMap.getGameBoard().get(19).get(1).addAttacker(new Marine());
