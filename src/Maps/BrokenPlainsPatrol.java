...
public class BrokenPlainsPatrol extends Map {
	...
	public void setPath() {
		...
		gameBoard.get(19).get(10).setMove(true, gameBoard.get(18).get(10)); // heading east
		...
		gameBoard.get(15).get(10).setMove(true, gameBoard.get(18).get(10));
		gameBoard.get(14).get(10).setBuild(false);
		
		//Spawn2 path to spawn2/3 intersection @ 9,6
		gameBoard.get(0).get(1).setMove(true, gameBoard.get(1).get(1)); // heading west
		...
		gameBoard.get(4).get(1).setMove(true, gameBoard.get(4).get(2)); // turn south
		...
		gameBoard.get(4).get(3).setMove(true, gameBoard.get(5).get(3)); // turn west
		...
		gameBoard.get(7).get(3).setMove(true, gameBoard.get(7).get(4)); // turn south
		...
		gameBoard.get(7).get(6).setMove(true, gameBoard.get(8).get(6)); // turn west
		...
		gameBoard.get(8).get(10).setMove(true, gameBoard.get(9).get(10)); // turn west
		...
		gameBoard.get(10).get(10).setMove(true, gameBoard.get(10).get(9)); // turn north
		...
		gameBoard.get(9).get(6).setMove(true, gameBoard.get(10).get(6)); //combine forces and move west
		...
		gameBoard.get(12).get(6).setMove(true, gameBoard.get(12).get(7)); // turn south
